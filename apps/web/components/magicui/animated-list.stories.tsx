...
const meta: Meta<typeof AnimatedList> = {
  title: "Magic UI/Effects/AnimatedList",
...
export const Default: Story = {
  render: () => (
    <div className="relative flex h-[400px] w-full max-w-[400px] flex-col overflow-hidden rounded-lg border bg-background p-6">
